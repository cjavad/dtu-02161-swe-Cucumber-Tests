Feature: Opret oversigter over aktiviteters timeforbrug
  Description:
  Actors: Projektleder
  ...
  Scenario: Generere oversigt hvor en aktivitet er over tid
  ...
  Scenario: Generere oversigt hvor en aktivitet er under tid
    Given at der findes en aktivitet med start tidspunkt i "01-2022" og slut tidspunkt "02-2022" ved navn "Feeding gibbon monkeys" og budgetteret tid på 10 timer
    And en anden medarbejder med ID "Gibs" har anført 9 timer på aktiviteten
    Then så er aktivitetens overtid -1 time

  Scenario: Generere oversigt hvor aktiviteten ikke har budgetteret tid
  ...
  Scenario: Generere oversigt hvor aktiviteten ikke har nogen anførte timer
